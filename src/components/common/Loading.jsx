    ...
    <div style={{ display: 'inline-block' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: children ? width / 4 : 0 }}>
        <svg width={width} height={width} viewBox={`0 0 24 24`} xmlns="http://www.w3.org/2000/svg">
          <style>{`.spinner_6kVp{transform-origin:center;animation:spinner_irSm .75s infinite linear;color: ${color};}@keyframes spinner_irSm{100%{transform:rotate(360deg)}}`}</style>
          <path
            fill={color}
