...
const Pair = ({ k, val, onRemove, onChangeVal, onChangeKey }) => {
  return (
    <div style={{ display: 'flex', width: '100%', gap: 5 }}>
      <div>
        <Input style={{ width: '120px' }} value={k} onChange={(e) => onChangeKey(e.target.value)} placeholder="Field" />
      </div>
      <div style={{ width: '100%' }}>
        <Input
          style={{ width: '100%' }}
      ...
      <div
        style={{ display: 'flex', alignItems: 'center', color: '#888', cursor: 'pointer', width: 20 }}
        onClick={onRemove}
      >
